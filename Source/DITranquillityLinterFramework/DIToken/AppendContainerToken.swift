...
class AppendContainerToken: DIToken {
	...
	init?(functionName: String, invocationBody: String, collectedInfo: [String : SwiftType], argumentStack: [ArgumentInfo], bodyOffset: Int64, file: File, currentPartName: String?) {
		...
		containerPart = ContainerPart(loadContainerStructure: loadContainerStructure, file: swiftType.file, collectedInfo: collectedInfo, currentPartName: typeName)
	}
